...
/scratch/chadbren_root/chadbren99/ppxinyi/canu-2.3/bin/canu -p L3 -d L3 \
  genomeSize=1m \
  -nanopore /scratch/chadbren_root/chadbren99/ppxinyi/Artifical_seq_reviewpaper/review_paper/pbsim3reads/localread/15000/l3/L3selected.fq \
...
ASM=/scratch/chadbren_root/chadbren99/ppxinyi/Artifical_seq_reviewpaper/review_paper/assembly/local/canu/15000/l3/L3/L3.contigs.fasta
